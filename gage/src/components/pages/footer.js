                    ...
                    <Col>
                        <div className='footer-box'>
                            ...
                            <ul className='footer-social-list'>
                                    <li>
                                        <a className='footer-social' href='https://github.com/Gaagggeeee'>
                                            <svg 
                                    ...
                                    <li>
                                        <a className='footer-social' href='https://codepen.io/Gaagggeeee'>
                                            <svg 
                                    ...
                                    <li>
                                        <a className='footer-social' href='https://www.linkedin.com/in/robert-everett-2811a91b9/'>
                                            <svg 
                                    ...
                                    <li>
                                        <a className='footer-social' href='https://www.instagram.com/gaagggeeee/'>
                                            <svg 
                                    ...
                                    <li>
                                        <a className='footer-social' href='mailto:rgeverett34@gmail.com'>
